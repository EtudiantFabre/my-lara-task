                ...
                <Card>
                    ...
                    <CardContent>
                        <div v-if="!isEditing">
                            ...
                            <div
                                v-if="isOverdue"
                                class="mt-2 flex items-center text-destructive text-sm"
                            >
                            ...
                            <div
                                v-else
                                class="mt-2 flex items-center text-muted-foreground text-sm"
                            >
                    ...
                    <form @submit.prevent="submitTask">
                        <div class="grid gap-4 py-4">
                            ...
                            <div class="grid grid-cols-2 gap-4">
                                <div class="space-y-2">
                                    <Label for="priority" :required="true"
                                        >Priorité</Label
                                    >
                                    <Select
                                ...
                                <div class="space-y-2">
                                    <Label for="due_date" :required="true"
                                        >Date d'échéance</Label
                                    >
                                    <Input
                                        id="due_date"
                            ...
                            <div class="space-y-2">
                                ...
                                <p
                                    ...
                                    class="text-sm text-destructive"
                                >
                                    {{ taskForm.errors.estimated_hours }}
                                </p>
                            </div>
                        </div>
            ...
            <Dialog v-model:open="showTaskEditModal">
                <DialogContent class="sm:max-w-[425px]">
                    ...
                    <form @submit.prevent="submitTaskEdit">
                        <div class="grid gap-4 py-4">
                            <div class="space-y-2">
                                <Label for="title_edit" :required="true"
                                    >Titre</Label
                                >
                                <Input
                                    id="title_edit"
                                ...
                                />
                                <p
                                    v-if="taskEditForm.errors.title"
                                    class="text-sm text-destructive"
                                >
                                    {{ taskEditForm.errors.title }}
                                </p>
                            </div>
                            <div class="space-y-2">
                                ...
                                />
                                <p
                                    v-if="taskEditForm.errors.description"
                                    class="text-sm text-destructive"
                                >
                            ...
                            <div class="grid grid-cols-2 gap-4">
                                <div class="space-y-2">
                                    ...
                                    />
                                    <p
                                        v-if="taskEditForm.errors.due_date"
                                        class="text-sm text-destructive"
                                    >
                                        {{ taskEditForm.errors.due_date }}
                                    </p>
                                </div>
                                <div class="space-y-2">
                                    <Label for="est_edit"
                                        >Temps estimé (h)</Label
                                    >
                                    <Input
                                        id="est_edit"
                                        type="number"
                                        ...
                                        step="0.5"
                                        v-model.number="
                                            taskEditForm.estimated_hours
                                        "
                                    />
                                    <p
                                        v-if="
                                            taskEditForm.errors.estimated_hours
                                        "
                                        class="text-sm text-destructive"
                                    >
                                        {{
            ...
            <Dialog v-model:open="showSubTaskModal">
                <DialogContent class="sm:max-w-[425px]">
                    ...
                    <form @submit.prevent="submitSubTask">
                        <div class="grid gap-4 py-4">
                            <div class="space-y-2">
                                <Label for="st_title" :required="true"
                                    >Titre</Label
                                >
                                <Input
                                    id="st_title"
                            ...
                            <div class="space-y-2">
                                ...
                                />
                                <p
                                    v-if="subTaskForm.errors.description"
                                    class="text-sm text-destructive"
                                >
                            ...
                            <div class="grid grid-cols-2 gap-4">
                                <div class="space-y-2">
                                    ...
                                    />
                                    <p
                                        v-if="subTaskForm.errors.due_date"
                                        class="text-sm text-destructive"
                                    >
                                        {{ subTaskForm.errors.due_date }}
                                    </p>
                                </div>
                                <div class="space-y-2">
                                    ...
                                    <Input
                                        ...
                                        step="0.5"
                                        v-model.number="
                                            subTaskForm.estimated_hours
                                        "
                                    />
                                    <p
                                        v-if="
                                            subTaskForm.errors.estimated_hours
                                        "
                                        class="text-sm text-destructive"
                                    >
                                        {{ subTaskForm.errors.estimated_hours }}
            ...
            <Dialog v-model:open="showSubTaskEditModal">
                <DialogContent class="sm:max-w-[425px]">
                    ...
                    <form @submit.prevent="submitSubTaskEdit">
                        <div class="grid gap-4 py-4">
                            <div class="space-y-2">
                                <Label for="st_title_edit" :required="true"
                                    >Titre</Label
                                >
                                <Input
                                    id="st_title_edit"
                                    v-model="subTaskEditForm.title"
                                    required
                                />
                                <p
                                    v-if="subTaskEditForm.errors.title"
                                    class="text-sm text-destructive"
                                >
                                    {{ subTaskEditForm.errors.title }}
                                </p>
                            </div>
                            <div class="space-y-2">
                                ...
                                <Textarea
                                    id="st_desc_edit"
                                    v-model="subTaskEditForm.description"
                                    class="min-h-[100px]"
                                />
                                <p
                                    v-if="subTaskEditForm.errors.description"
                                    class="text-sm text-destructive"
                                >
                                    {{ subTaskEditForm.errors.description }}
                                </p>
                            </div>
                            <div class="grid grid-cols-2 gap-4">
                                <div class="space-y-2">
                                    ...
                                    <Input
                                        id="st_due_edit"
                                        type="date"
                                        v-model="subTaskEditForm.due_date"
                                        :min="format(new Date(), 'yyyy-MM-dd')"
                                    />
                                    <p
                                        v-if="subTaskEditForm.errors.due_date"
                                        class="text-sm text-destructive"
                                    >
                                        {{ subTaskEditForm.errors.due_date }}
                                    </p>
                                </div>
                                <div class="space-y-2">
                                    <Label for="st_est_edit"
                                        >Temps estimé (h)</Label
                                    >
                                    <Input
                                        id="st_est_edit"
                                        ...
                                        step="0.5"
                                        v-model.number="
                                            subTaskEditForm.estimated_hours
                                        "
                                    />
                                    <p
                                        v-if="
                                            subTaskEditForm.errors
                                                .estimated_hours
                                        "
                                        class="text-sm text-destructive"
                                    >
                        ...
                        <div class="flex justify-end gap-2 pt-2">
                            <Button
                                type="button"
                                variant="outline"
                                @click="showSubTaskEditModal = false"
                                >Annuler</Button
                            >
                            <Button
                                type="submit"
                                :disabled="subTaskEditForm.processing"
                                >Enregistrer</Button
                            >
                        </div>
                    </form>
...
const toggleSubTask = async (task, st) => {
    try {
        await axios.patch(
            route("subtasks.toggle", { task: task.id, subTask: st.id })
        );
        reloadProject();
    } catch (e) {
        toast({
...
const deleteSubTask = (task, st) => {
    ...
    router.delete(
        route("subtasks.destroy", { task: task.id, subTask: st.id }),
        {
            preserveScroll: true,
            onSuccess: () => {
                toast({
...
const submitSubTaskEdit = () => {
    ...
    subTaskEditForm.patch(
        route("subtasks.update", {
            task: selectedTask.value.id,
            subTask: selectedSubTask.value.id,
        }),
        {
            preserveScroll: true,
            onSuccess: () => {
                showSubTaskEditModal.value = false;
                toast({
                    title: "Succès",
